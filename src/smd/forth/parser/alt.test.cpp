// src/smd/forth/parser/alt.test.cpp                                 -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::smdscheme):
// src/smd/smdscheme/parser/alt.test.cpp

#include <smd/forth/parser/alt.hpp>
#include <smd/forth/parser/alt.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

namespace {

using namespace smd::forth::parser;
