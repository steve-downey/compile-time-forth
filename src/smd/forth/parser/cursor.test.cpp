// src/smd/forth/parser/cursor.test.cpp                              -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::smdscheme):
// src/smd/smdscheme/parser/cursor.test.cpp

#include <smd/forth/parser/cursor.hpp>
#include <smd/forth/parser/cursor.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

using smd::forth::parser::cursor;
using smd::forth::parser::is_space;
using smd::forth::parser::skip_intertoken_space;
