// src/smd/forth/parser/parser.test.cpp                              -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::smdscheme):
// src/smd/smdscheme/parser/parser.test.cpp

#include <smd/forth/parser/parser.hpp>
#include <smd/forth/parser/parser.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

using smd::forth::parser::char_p;
using smd::forth::parser::cursor;
using smd::forth::parser::lift2;
using smd::forth::parser::map;
using smd::forth::parser::pure;
using smd::forth::parser::satisfy;
using smd::forth::parser::sequence_left;
using smd::forth::parser::sequence_right;
