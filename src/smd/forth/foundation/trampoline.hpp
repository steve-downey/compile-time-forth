// src/smd/forth/foundation/trampoline.hpp                           -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/trampoline.hpp
...
#ifndef SRC_SMD_FORTH_FOUNDATION_TRAMPOLINE_HPP
#define SRC_SMD_FORTH_FOUNDATION_TRAMPOLINE_HPP
