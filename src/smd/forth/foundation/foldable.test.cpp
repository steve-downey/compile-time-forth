// src/smd/forth/foundation/foldable.test.cpp                        -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/foldable.test.cpp
// Moved in step R8 (decision 2, corrected) from
// src/smd/cl/foundation/foldable.test.cpp.

#include <smd/forth/foundation/foldable.hpp>
#include <smd/forth/foundation/foldable.hpp> // test 2nd include OK
...
using smd::forth::foundation::derive_foldable;
using smd::forth::foundation::empty;
using smd::forth::foundation::fold_left;
using smd::forth::foundation::fold_map;
using smd::forth::foundation::fold_right;
using smd::forth::foundation::foldable;
using smd::forth::foundation::length;
using smd::forth::foundation::static_vector;
...
static_assert(smd::forth::foundation::foldable_impl<pair_box_foldable_impl,
                                                    pair_box<int>>);
static_assert(smd::forth::foundation::foldable_object<pair_box_foldable_map,
                                                      pair_box<int>>);

// The Impl has the two primitives and none of the derived surface.
static_assert(!smd::forth::foundation::foldable_object<pair_box_foldable_impl,
                                                       pair_box<int>>);
