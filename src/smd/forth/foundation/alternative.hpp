// src/smd/forth/foundation/alternative.hpp                          -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/alternative.hpp
...
// R8 acts on.
#ifndef SRC_SMD_FORTH_FOUNDATION_ALTERNATIVE_HPP
#define SRC_SMD_FORTH_FOUNDATION_ALTERNATIVE_HPP
...
struct alt_fn {
    ...
    constexpr auto operator()(A &&a, B &&b) const {
        static_assert(has_instance_v<decltype(TC)>,
                      ...
                      "smd::forth::foundation::alternative<T> with an object "
