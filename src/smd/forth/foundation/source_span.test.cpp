// src/smd/forth/foundation/source_span.test.cpp                    -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::smdscheme):
// src/smd/smdscheme/foundation/source_span.test.cpp

#include <smd/forth/foundation/source_span.hpp>
#include <smd/forth/foundation/source_span.hpp> // test 2nd include OK
