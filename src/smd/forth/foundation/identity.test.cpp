// src/smd/forth/foundation/identity.test.cpp                        -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/identity.test.cpp
// Moved in step R8 (decision 2, corrected) from
// src/smd/cl/foundation/identity.test.cpp.

#include <smd/forth/foundation/identity.hpp>
#include <smd/forth/foundation/identity.hpp> // test 2nd include OK
