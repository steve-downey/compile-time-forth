// src/smd/forth/foundation/monad.test.cpp                          -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/monad.test.cpp

#include <smd/forth/foundation/monad.hpp>
#include <smd/forth/foundation/monad.hpp> // test 2nd include OK
...
using smd::forth::foundation::bind;
using smd::forth::foundation::identity;
using smd::forth::foundation::identity_monad_map;
using smd::forth::foundation::invoke;
using smd::forth::foundation::join;
using smd::forth::foundation::parse_error;
using smd::forth::foundation::result;
using smd::forth::foundation::result_monad_map;
...
static_assert(
    !smd::forth::foundation::functor_object<result_monad_map, result<int>>);
...
static_assert(
    std::is_same_v<decltype(result_monad_map{}.as_functor()),
                   smd::forth::foundation::derive_functor<result_monad_map>>);
...
static_assert(
    smd::forth::foundation::monad_object<result_monad_map, result<int>>);
static_assert(
    smd::forth::foundation::monad_object<identity_monad_map, identity<int>>);
static_assert(!smd::forth::foundation::monad_object<
              smd::forth::foundation::result_functor_map, result<int>>);
