// src/smd/forth/foundation/fold_left_short.test.cpp                 -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/fold_left_short.test.cpp
...
#include <smd/forth/foundation/fold_left_short.hpp> // test 2nd include OK
...
using smd::forth::foundation::fold_left_short;
using smd::forth::foundation::parse_error;
using smd::forth::foundation::result;
using smd::forth::foundation::short_circuit_effect;
