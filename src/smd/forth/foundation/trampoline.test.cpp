// src/smd/forth/foundation/trampoline.test.cpp                      -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/trampoline.test.cpp
// Moved in step R8 (decision 2, corrected) from
// src/smd/cl/foundation/trampoline.test.cpp.

#include <smd/forth/foundation/trampoline.hpp>
#include <smd/forth/foundation/trampoline.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

using smd::forth::foundation::step_status;
using smd::forth::foundation::trampoline;
