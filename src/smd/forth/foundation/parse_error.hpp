// src/smd/forth/foundation/parse_error.hpp                         -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::smdscheme):
// src/smd/smdscheme/foundation/parse_error.hpp
#ifndef SRC_SMD_FORTH_FOUNDATION_PARSE_ERROR_HPP
#define SRC_SMD_FORTH_FOUNDATION_PARSE_ERROR_HPP
