// src/smd/forth/foundation/static_vector_instances.test.cpp         -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/static_vector_instances.test.cpp
// Moved in step R8 (decision 2, corrected) from
// src/smd/cl/foundation/static_vector_instances.test.cpp.

#include <smd/forth/foundation/static_vector_instances.hpp>
#include <smd/forth/foundation/static_vector_instances.hpp> // test 2nd include OK

#include <smd/forth/foundation/fold_left_short.hpp>
