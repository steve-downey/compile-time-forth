// src/smd/forth/foundation/result.hpp                               -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/result.hpp
...
#ifndef SRC_SMD_FORTH_FOUNDATION_RESULT_HPP
#define SRC_SMD_FORTH_FOUNDATION_RESULT_HPP
...
// forwarder to it, both in <smd/forth/foundation/result_instances.hpp>. It
