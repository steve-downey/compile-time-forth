// src/smd/forth/foundation/functor.hpp                              -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/functor.hpp
...
// R8 acts on.
#ifndef SRC_SMD_FORTH_FOUNDATION_FUNCTOR_HPP
#define SRC_SMD_FORTH_FOUNDATION_FUNCTOR_HPP
...
struct fmap_fn {
    ...
    constexpr auto operator()(F &&f, T &&value) const {
        static_assert(has_instance_v<decltype(TC)>,
                      ...
                      "smd::forth::foundation::functor<T> with an object "
