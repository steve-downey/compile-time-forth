// src/smd/forth/foundation/induced_monoid.test.cpp                   -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/induced_monoid.test.cpp

#include <smd/forth/foundation/induced_monoid.hpp>
#include <smd/forth/foundation/induced_monoid.hpp> // test 2nd include OK
...
using smd::forth::foundation::identity_applicative_map;
using smd::forth::foundation::kleisli_endo;
using smd::forth::foundation::lifted;
using smd::forth::foundation::monoid;
using smd::forth::foundation::parse_error;
using smd::forth::foundation::result;
using smd::forth::foundation::result_applicative_map;
...
static_assert(
    !smd::forth::foundation::has_instance_v<decltype(monoid<result<int>>)>);
