// src/smd/forth/foundation/applicative.hpp                          -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/applicative.hpp
...
// R8 acts on.
#ifndef SRC_SMD_FORTH_FOUNDATION_APPLICATIVE_HPP
#define SRC_SMD_FORTH_FOUNDATION_APPLICATIVE_HPP
...
struct invoke_fn {
    ...
    constexpr auto operator()(Function &&function, FirstArg &&first_arg,
        ...
        static_assert(has_instance_v<decltype(TC)>,
                      ...
                      "smd::forth::foundation::applicative<T> with an object "
