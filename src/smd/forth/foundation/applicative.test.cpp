// src/smd/forth/foundation/applicative.test.cpp                     -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/applicative.test.cpp
...
#include <smd/forth/foundation/applicative.hpp> // test 2nd include OK
...
using smd::forth::foundation::derive_applicative;
...
static_assert(smd::forth::foundation::applicative_object<logged_applicative_map,
                                                         logged<int>>);
static_assert(
    smd::forth::foundation::applicative_object<apply_only_map, logged<int>>);
static_assert(smd::forth::foundation::applicative_impl<logged_applicative_impl,
                                                       logged<int>>);
...
static_assert(!smd::forth::foundation::applicative_object<
              logged_applicative_impl, logged<int>>);
