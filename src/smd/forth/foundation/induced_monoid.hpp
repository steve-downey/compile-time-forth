// src/smd/forth/foundation/induced_monoid.hpp                       -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/induced_monoid.hpp
...
// representation.
#ifndef SRC_SMD_FORTH_FOUNDATION_INDUCED_MONOID_HPP
#define SRC_SMD_FORTH_FOUNDATION_INDUCED_MONOID_HPP
