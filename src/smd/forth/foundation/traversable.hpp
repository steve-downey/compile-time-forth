// src/smd/forth/foundation/traversable.hpp                          -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/traversable.hpp
...
// or an AST.
#ifndef SRC_SMD_FORTH_FOUNDATION_TRAVERSABLE_HPP
#define SRC_SMD_FORTH_FOUNDATION_TRAVERSABLE_HPP
...
struct traverse_fn {
    ...
    constexpr auto operator()(F &&f, T const &container) const {
        static_assert(has_instance_v<decltype(TC)>,
                      ...
                      "smd::forth::foundation::traversable<T> with an object "
