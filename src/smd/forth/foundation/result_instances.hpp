// src/smd/forth/foundation/result_instances.hpp                     -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/result_instances.hpp
...
// workaround (reopening smd::forth::foundation from a file that stayed under
// cl to name a cl-qualified type) is gone, not merely hidden, because the
// type moved rather than just the typeclass.
#ifndef SRC_SMD_FORTH_FOUNDATION_RESULT_INSTANCES_HPP
#define SRC_SMD_FORTH_FOUNDATION_RESULT_INSTANCES_HPP
...
/// (<smd/forth/foundation/fold_left_short.hpp>). Deriving @c apply from
