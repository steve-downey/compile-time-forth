// src/smd/forth/foundation/typeclass_base.hpp                       -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/typeclass_base.hpp
...
#ifndef SRC_SMD_FORTH_FOUNDATION_TYPECLASS_BASE_HPP
#define SRC_SMD_FORTH_FOUNDATION_TYPECLASS_BASE_HPP
