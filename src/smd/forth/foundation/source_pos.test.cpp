// src/smd/forth/foundation/source_pos.test.cpp                     -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::smdscheme):
// src/smd/smdscheme/foundation/source_pos.test.cpp

#include <smd/forth/foundation/source_pos.hpp>
#include <smd/forth/foundation/source_pos.hpp> // test 2nd include OK
