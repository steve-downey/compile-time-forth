// src/smd/forth/foundation/monoid.hpp                               -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/monoid.hpp
...
// steps.
#ifndef SRC_SMD_FORTH_FOUNDATION_MONOID_HPP
#define SRC_SMD_FORTH_FOUNDATION_MONOID_HPP
