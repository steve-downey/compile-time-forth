// src/smd/forth/foundation/fold_left_short.hpp                      -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/fold_left_short.hpp
...
#ifndef SRC_SMD_FORTH_FOUNDATION_FOLD_LEFT_SHORT_HPP
#define SRC_SMD_FORTH_FOUNDATION_FOLD_LEFT_SHORT_HPP
