// src/smd/forth/foundation/foldable.hpp                             -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/foldable.hpp
...
// or an AST.
#ifndef SRC_SMD_FORTH_FOUNDATION_FOLDABLE_HPP
#define SRC_SMD_FORTH_FOUNDATION_FOLDABLE_HPP
...
struct fold_map_fn {
    ...
    constexpr auto operator()(F &&f, T const &container, M const &m) const {
        static_assert(has_instance_v<decltype(TC)>,
                      ...
                      "smd::forth::foundation::foldable<T> with an object "
...
struct fold_left_fn {
    ...
    constexpr auto operator()(F &&f, Acc init, T const &container) const
        ...
        static_assert(has_instance_v<decltype(TC)>,
                      "No Foldable instance for this type. Specialize "
                      "smd::forth::foundation::foldable<T>.");
