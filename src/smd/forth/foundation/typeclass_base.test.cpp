// src/smd/forth/foundation/typeclass_base.test.cpp                   -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/typeclass_base.test.cpp

#include <smd/forth/foundation/typeclass_base.hpp>
#include <smd/forth/foundation/typeclass_base.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

#include <type_traits>

namespace kf = smd::forth::foundation;
