// src/smd/forth/foundation/static_vector_instances.hpp              -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/static_vector_instances.hpp
...
// initial extraction's workaround (reopening smd::forth::foundation from a
...
// in that same order.
#ifndef SRC_SMD_FORTH_FOUNDATION_STATIC_VECTOR_INSTANCES_HPP
#define SRC_SMD_FORTH_FOUNDATION_STATIC_VECTOR_INSTANCES_HPP
