// src/smd/forth/foundation/static_vector.hpp                        -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/static_vector.hpp
...
#ifndef SRC_SMD_FORTH_FOUNDATION_STATIC_VECTOR_HPP
#define SRC_SMD_FORTH_FOUNDATION_STATIC_VECTOR_HPP
