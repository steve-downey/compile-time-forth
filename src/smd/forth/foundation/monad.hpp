...
#ifndef SRC_SMD_FORTH_FOUNDATION_MONAD_HPP
#define SRC_SMD_FORTH_FOUNDATION_MONAD_HPP
...
/// in <smd/forth/foundation/fold_left_short.hpp>. It is not a Monad
...
struct bind_fn {
    ...
    constexpr auto operator()(M &&m, F &&f) const {
        static_assert(has_instance_v<decltype(TC)>,
                      ...
                      "smd::forth::foundation::monad<T> with an object "
