// src/smd/forth/foundation/result_instances.test.cpp                -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/result_instances.test.cpp
...
#include <smd/forth/foundation/result_instances.hpp> // test 2nd include OK
