// src/smd/forth/foundation/identity.hpp                             -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// Adapted by copy from compile-time-scheme (smd::kit::foundation):
// src/smd/kit/foundation/identity.hpp
...
// qualification.
#ifndef SRC_SMD_FORTH_FOUNDATION_IDENTITY_HPP
#define SRC_SMD_FORTH_FOUNDATION_IDENTITY_HPP
...
/// gives the laws in <smd/forth/foundation/monad.test.cpp> a second instance
