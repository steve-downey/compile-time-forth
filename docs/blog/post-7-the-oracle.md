...
[↑ Series Index](index.md) | [Part 6 - Elaboration and the Effect Checker ←](post-6-elaboration.md)
...
The acceptance test I set for this step is a countdown, and it is lifted straight from the plan's own text:
...
Last entry I described a blind spot in the effect checker: it is not flow-sensitive across `EXIT`, so
...
[↑ Series Index](index.md) | [← Part 6 - Elaboration and the Effect Checker](post-6-elaboration.md) | [Part 8 - The Program That Survives to Runtime →](post-8-survives-to-runtime.md)
